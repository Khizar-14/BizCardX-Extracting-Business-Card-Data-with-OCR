...
mydb = mysql.connector.connect(
    user='root',
    host='localhost',
    password='Root@1234', auth_plugin='mysql_native_password')
...
icon = Image.open("C:\\Users\\Khiza\\Downloads\\business_card_desing_1_4x.jpg")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By Khizar Hussain",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *Khizar Hussain*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:\\Users\\Khiza\\Downloads\\business_card_desing_1_4x.jpg"), width=500)
